1) This app is created using Angular v17 with Angular material and a node.js server using Express.js. I have created my own mock server with dummyData required to run the application.
